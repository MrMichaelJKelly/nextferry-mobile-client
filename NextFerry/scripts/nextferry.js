...
var NextFerry = (function ($) {
	...
	var NFDate = {
		_tschedt : null,
		nowD : function() { return new Date( Date.now() ); },
	...
	// reminder: times are minutes past midnite, with
	// some caveats (see original code)
	var Noon = 12 * 60;
